...
else if(/nfstar|nfxtv|nfxhd|zhenbuka|cokemv|lekkan|4kan|nkvod/.test(spl)){var url=spl+'/vodtype/'+clsu[i]+'-fypage/';}
...
else if(/nkvod/.test(url)){url=url+'/ssvod/'+spl[2]+'----------fypage---/';}
