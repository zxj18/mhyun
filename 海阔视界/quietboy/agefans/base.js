...
const _config = {
  home_name: "AGE动漫",
  remote_update: 'https://gitee.com/f11st/hiker/raw/master/agefans/update.json',
  local_js: 'hiker://files/quietboy/agefans/main.js',
  local_config_path: 'hiker://files/quietboy/agefans/config.json',
}
