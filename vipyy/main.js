...
var vip = {
    'parwix': function (url) {
        ...
        if (ret.indexOf('mgtv.com') > 0) {
            ret += ';{User-Agent@Mozilla/5.0 (Windows NT 10.0；； WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.87 Safari/537.36&&Referer@https://www.mgtv.com.parwix.com:4433/}';
        }
        return ret;
    }
}
    ...
    var vipyy = {
        getPlay: function (url) {
            ...
            if (player_data["from"] == "qqpic") {
                ...
                // let resCodeQqpic = fetch(_domin_zbk + "zhenbuka/player/resourceServerPlayer.php?id=" + player_data["url"], {
                //     headers: {
                //         "Referer": _domin_zbk
                //     },
                //     method: "GET"
                // });
                // let resCodeQqpic1 = fetch(parseDom(resCodeQqpic, "iframe&&src"), {
                //     headers: {
                //         "Referer": _domin_zbk
                //     },
                //     method: "GET"
                // });
                // eval(resCodeQqpic1["split"]('<script type="text/javascript">')[1]["split"]("var nx_cpatcha")[0]);
                // play = _domin_zbk + "hls/" + src + "%7C" + ti + "%7C" + sk + "%7C" + pt + "%7C" + tools["getBkn"](sk) + "%7C" + tools["getGtk"](pt) + ".m3u8";
